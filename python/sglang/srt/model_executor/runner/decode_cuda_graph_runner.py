...
class DecodeCudaGraphRunner(BaseCudaGraphRunner):
    ...
    def _make_graph_key(self, bs, stream_idx=None, variant_label=None, dsa_variant=None):
        return ShapeKey(
            size=bs,
        ...
        with forward_context(ForwardContext(attn_backend=attn_backend)):
            ...
            with canary_ctx:
                shape_key = self._make_graph_key(
                    bs, stream_idx, variant_label, dsa_variant
                )
    ...
    def load_batch(
        ...
        if not forward_batch.needs_forward_metadata_init():
            ...
            self._replay_graph_key = self._make_graph_key(
                self.bs, stream_idx, variant_label, dsa_variant
            )
            return
